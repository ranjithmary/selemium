...
System.out.println("Before finding Duplicates" +size);

Set element = new LinkedHashSet();
element.addAll(options);
int size2 = element.size();
System.out.println("After Finding Duplicates"+size2);
